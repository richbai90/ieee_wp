...
class fundor_setup_sidebar {
    ...
    public function body_class($classes){
        $classes[] = 'opal-content-layout-default';
    ...
    public function init_sidebar(){
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'fundor'),
            'id'            => 'sidebar-blog',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'fundor'),
...
return new fundor_setup_sidebar();