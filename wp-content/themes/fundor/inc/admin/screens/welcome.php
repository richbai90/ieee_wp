                ...
                <div class="box-import box-shadow mb-30">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 d-flex align-items-center">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div>
                                        <h3 class="large-title c-primary"><?php esc_html_e( 'Import Demo', 'fundor' ) ?></h3>
										<?php if ( $status['plugin_required'] ) { ?>
                                            <p class="text-description"><?php esc_html_e( 'Please check and make sure that all required plugins are set up on your website', 'fundor' ) ?></p>
                                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=opal-theme-plugins' ) ); ?>"
                                               class="opal-btn-primary"><?php esc_html_e( 'Install Plugins', 'fundor' ) ?></a>
										<?php } else { ?>
                                            <p class="text-description"><?php esc_html_e( 'Clone a demo site in few clicks', 'fundor' ) ?></p>
                                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=pt-one-click-demo-import' ) ); ?>"
                                               class="opal-btn-primary"><?php esc_html_e( 'Run Importer', 'fundor' ) ?></a>
										<?php } ?>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12 bl-lg-so-1 d-flex align-items-center">
                            <div class="pl-lg-2">
                                <h2 class="medium-title pb-3 mt-lg-0"><?php esc_html_e( 'System Status', 'fundor' ) ?></h2>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow mb-30">
                    <img class="img-auto"
                         ...
                         title="<?php esc_html_e( 'WP Themelexus', 'fundor' ) ?>">
                    <h3><?php esc_html_e( 'Support Cover', 'fundor' ) ?></h3>
                    <p><?php esc_html_e( 'We’ll give you a reply within 24 hours except during weekends.', 'fundor' ) ?></p>
                    <div class="box-footer">
                        <a href="https://themelexus.ticksy.com/" target="_blank"
                           class="opal-btn-secondary mt-4"><?php esc_html_e( 'Submit Ticket', 'fundor' ) ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="<?php esc_html_e( 'WP Themelexus', 'fundor' ) ?>">
                    <h3><?php esc_html_e( 'Documentation', 'fundor' ) ?></h3>
                    <p><?php esc_html_e( 'Read all documentation for our themes. Any questions or training needed for WordPress themes can be  found here.', 'fundor' ) ?></p>
                    <div class="box-footer">
                        <a href="<?php echo esc_url('https://wpdocs.gitbook.io/fundor/') ?>" class="opal-btn-primary mt-4"><?php esc_html_e( 'Explore Now', 'fundor' ) ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="<?php esc_html_e( 'WP Themelexus', 'fundor' ) ?>">
                    <h3><?php esc_html_e( 'Our Information', 'fundor' ) ?></h3>
                    <p><?php esc_html_e( 'Checkout our site and social for more information.', 'fundor' ) ?></p>
                    <a href="https://www.wpopal.com/"
                       class="mb-3"><?php esc_html_e( 'www.themelexus.com', 'fundor' ); ?></a>
                    <div class="box-footer social">
                        <ul class="list-social">
                            <li>
                                <a href="https://themeforest.net/user/themelexus">
                            ...
                            <li>
                                <a href="mailto:info@themelexus.com">
