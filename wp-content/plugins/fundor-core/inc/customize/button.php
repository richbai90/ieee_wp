...
$cssCode .= <<<CSS
    button ,input[type="submit"], input[type="reset"], input[type="button"], .button, .btn, .elementor-element .elementor-button, .elementor-element .elementor-button-link .elementor-button {
        {$button_css}
        {$font_style_code}
    }
CSS;
