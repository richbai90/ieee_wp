...
$page_title_bg_color = get_theme_mod('osf_colors_page_title_bg', '#1a160e');
$page_title_bg_image = get_theme_mod('osf_colors_page_title_bg_image');
$page_title_color = get_theme_mod('osf_colors_page_title_heading_color', '#fff');
$breadcrumb_color = get_theme_mod('osf_colors_page_title_breadcrumb_color', '#fff');
...
$breadcrumb_color_hover = get_theme_mod('osf_colors_page_title_breadcrumb_color_hover', '#fff');
if ($breadcrumb_color_hover && $breadcrumb_color_hover != '#fff') {
    $cssCode .= <<<CSS
...
$breadcrumb_separator_color = get_theme_mod('osf_colors_page_title_breadcrumb_separator_color');
if ($breadcrumb_separator_color) {
    $cssCode .= <<<CSS
