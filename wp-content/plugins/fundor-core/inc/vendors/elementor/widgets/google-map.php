...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'fundor-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'fundor-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'fundor-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'fundor-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'fundor-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'fundor-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'fundor-core' ),
        ...
        $this->start_controls_section(
            'section_style_map',
            [
                'label' => __( 'Map Style', 'fundor-core' ),
        ...
        $this->add_control(
            'all',
            [
                'label' => __( 'All Color', 'fundor-core' ),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_color',
            [
                'label' => __( 'Poi Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'fundor-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    protected function render() {
        ...
        $api_key = osf_get_option('opal-settings', 'api_key', 'AIzaSyCfMVNIa7khIqYHCw6VBn8ShUWWm4tjbG8');
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'fundor-core'),
            'shades_of_grey' => __('Shades of Grey', 'fundor-core'),
            'blue_water' => __('Blue Water', 'fundor-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'fundor-core'),
            'farma_gray' => __('Farma Gray', 'fundor-core'),
            'community' => __('Community', 'fundor-core'),
            'chilled' => __('Chilled', 'fundor-core'),
            'customize' => __('Customize', 'fundor-core')
