...
class OSF_Elementor_Image_Layers_Widget extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'fundor-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label' => esc_html__('Select Content', 'fundor-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'fundor-core'),
                    'text' => esc_html__('Text Content', 'fundor-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label' => esc_html__('Upload Image', 'fundor-core'),
        ...
        $repeater->add_control('img_layers_alt',
            [
                'label' => esc_html__('Alt', 'fundor-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label' => esc_html__('Content', 'fundor-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Lorem ipsum dolor sit amet', 'fundor-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('text_color',
            [
                'label' => esc_html__('Color', 'fundor-core'),
        ...
        $repeater->add_control('img_layers_position',
            [
                'label' => esc_html__('Position', 'fundor-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'fundor-core'),
                    'absolute' => esc_html__('Absolute', 'fundor-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label' => esc_html__('Horizontal Offset', 'fundor-core'),
                'type' => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'fundor-core'),
                'size_units' => ['px', "em", '%'],
                'range' => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label' => esc_html__('Vertical Offset', 'fundor-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'fundor-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', "em", '%'],
                'range' => [
        ...
        $repeater->add_control('img_layers_link_selection',
            [
                'label' => esc_html__('Link Type', 'fundor-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'fundor-core'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label' => esc_html__('Degrees', 'fundor-core'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'fundor-core'),
                'min' => -180,
                'max' => 180,
                'condition' => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label' => esc_html__('Entrance Animation', 'fundor-core'),
        ...
        $repeater->add_control('img_layers_animation_duration',
            [
                ...
                'default' => '',
                'options' => [
                    'slow' => __('Slow', 'fundor-core'),
                    '' => __('Normal', 'fundor-core'),
                    'fast' => __('Fast', 'fundor-core'),
                ],
                'condition' => [
                    'img_layers_animation_switcher' => 'yes',
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label' => esc_html__('Animation Delay', 'fundor-core') . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '',
                'min' => 0,
                'step' => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label' => esc_html__('Mousemove Interactivity', 'fundor-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'fundor-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label' => esc_html__('Interactivity Style', 'fundor-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'parallax' => esc_html__('Mouse Parallax', 'fundor-core'),
                    'tilt' => esc_html__('Tilt', 'fundor-core'),
                ],
                'default' => 'parallax',
                'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label' => esc_html__('Rate', 'fundor-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => -10,
                'min' => -20,
                'max' => 20,
                'step' => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'fundor-core'),
                'separator' => 'after',
                'label_block' => true,
                'condition' => [
                    'img_layers_mouse' => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label' => esc_html__('z-index', 'fundor-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label' => esc_html__('CSS Classes', 'fundor-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'fundor-core'),
            ]
        );
        ...
        $this->start_controls_section('img_layers_container_style',
            [
                'label' => esc_html__('Container', 'fundor-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
