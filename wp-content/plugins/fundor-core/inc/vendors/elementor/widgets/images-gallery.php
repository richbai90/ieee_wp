...
class OSF_Elementor_Image_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Image Gallery', 'fundor-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => __('Image Gallery', 'fundor-core'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => __('Filter Title', 'fundor-core'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('List Item', 'fundor-core'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => __('Add Images', 'fundor-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => __('Gallery 1', 'fundor-core'),
                    ],
                ],
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => __('Filter Bar', 'fundor-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Infinite Scroll', 'fundor-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __('Off', 'fundor-core'),
                'label_on'  => __('On', 'fundor-core'),
            ]
...
//                'exclude'   => ['custom'],
        ...
        $this->add_control(
            ...
            [
                'label'      => __('Image Spacing', 'fundor-core'),
                'type'       => Controls_Manager::SLIDER,
                'show_label' => false,
                'range'      => [
                    'px' => [
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'image_border',
                'selector'  => '{{WRAPPER}} .column-item a',
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => __('Filter Padding', 'fundor-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
    ...
    protected function render() {
        ...
        if ($settings['show_filter_bar'] == 'yes') {
            ...
            foreach ($settings['filter'] as $index => $item) {
                $all_item += count($item['wp_gallery']);
            }
            ?>
            <ul class="elementor-galerry__filters"
                ...
                <li class="elementor-galerry__filter elementor-active"
                    data-filter=".__all"><?php echo __('All', 'fundor-core').'<sup>'.esc_html($all_item).'</sup>'; ?></li>
                <?php foreach ($settings['filter'] as $key => $term) {
                    ?>
                    <li class="elementor-galerry__filter"
                        data-filter=".gallery_group_<?php echo esc_attr($key); ?>"><?php echo $term['filter_title'].'<sup>'.esc_html(count($term['wp_gallery'])).'</sup>'; ?></li>
                <?php } ?>
            </ul>
            <?php
        }
            ...
            <div <?php echo $this->get_render_attribute_string('row') ?>>
                ...
                if ($settings['active_infinite_scroll'] == 'yes') {
                    foreach ($image_gallery as $index => $item) {
                        ...
                        if ($index < 10) {
                            ?>
                            <div class="column-item gallery-item grid__item masonry-item __all <?php echo 'gallery_group_' . esc_attr($item['group']); ?>">
