...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'fundor-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'fundor-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'fundor-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'fundor-core' ),
                    'minimal' => __( 'Minimal', 'fundor-core' ),
                    'framed' => __( 'Framed', 'fundor-core' ),
                    'boxed' => __( 'Boxed Icon', 'fundor-core' ),
                    'flat' => __( 'Flat', 'fundor-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'rounded' => __( 'Rounded', 'fundor-core' ),
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'fundor-core' ),
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
        ...
        $this->add_control(
            'text_padding',
            [
                'label' => __( 'Text Padding', 'fundor-core' ),
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'fundor-core'), $title)?>">
