...
class OSF_Elementor_Search_Form extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Search Form', 'fundor-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'search_content',
            [
                'label' => __( 'Search Form', 'fundor-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'full_screen' => __( 'Full Screen', 'fundor-core' ),
                ],
        ...
        $this->add_control(
            'placeholder',
            [
                'label' => __( 'Placeholder', 'fundor-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Search', 'fundor-core' ) . '...',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'icon',
                'options' => [
                    'icon' => __( 'Icon', 'fundor-core' ),
                    'text' => __( 'Text', 'fundor-core' ),
                    'text_icon' => __( 'Text & Icon', 'fundor-core' ),
                ],
        ...
        $this->add_responsive_control(
            'button_width',
            [
                'label' => __( 'Button Width', 'fundor-core' ),
                'type' => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
    ...
    protected function render() {
        ...
        if ( 'icon' == $settings['button_type'] ) {
            ...
            if ( isset($settings['icon']) && 'arrow' == $settings['icon'] ) {
            ...
            <div class="elementor-search-form__container">
                ...
                <?php if ( 'full_screen' === $settings['skin'] ) : ?>
                    <div class="dialog-lightbox-close-button dialog-close-button">
                        ...
                        <span class="elementor-screen-only"><?php esc_html_e( 'Close', 'fundor-core' ); ?></span>
                    </div>
                <?php endif ?>
            </div>
        </form>
