...
class OSF_Elementor_Widget_Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return __( 'Social Icons', 'fundor-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => __( 'Social Icons', 'fundor-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Official Color', 'fundor-core' ),
...
$widgets_manager->register_widget_type(new OSF_Elementor_Widget_Social_Icons());