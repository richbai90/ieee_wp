...
function osf_get_google_fonts() {
    $content = file_get_contents(FUNDOR_CORE_PLUGIN_DIR . 'webfonts.json');
...
function osf_get_fonts_url() {
    ...
    if (is_array($button_font) && $button_font['family']) {
        //        $font_families[] = "{$heading_font['family']}";
        $font_families[] = "{$button_font['family']}:{$button_font['fontWeight']}";
        $subsets[]       = $button_font['subsets'];
    }
...
function time_elapsed_string($datetime, $full = false) {
    ...
    $string = array(
        'y' => __('year', 'fundor-core'),
        'm' => __('month', 'fundor-core'),
        'w' => __('week', 'fundor-core'),
        'd' => __('day', 'fundor-core'),
        //        'h' => __('hour', 'fundor-core'),
        //        'i' => __('minute', 'fundor-core'),
        //        's' => __('second', 'fundor-core'),
    );
    ...
    return $string ? implode(', ', $string) . __(' left', 'fundor-core') : __('just now', 'fundor-core');
}